...
## Acceptance Criteria
- [x] Drag-and-drop file upload supporting image formats and PDFs.
- [x] Split rule toggles (Equal 50/50, By Room Size, Custom %).
- [x] One-click preset bill buttons (Electricity ₹2,450, Wifi ₹1,199, Groceries ₹3,280, Rent ₹60,000).
- [x] Loading state with visual pulse animation during Gemini extraction.
